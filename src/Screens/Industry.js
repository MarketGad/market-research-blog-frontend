                            ...
                            <div className="row">
                                <div className="col l9 s12">
                                    <img
                                        ...
                                        src="https://res.cloudinary.com/marketgaddevcloud1/image/upload/v1594916046/Articles%20Photos/Industry/Logistic%20Sector%20of%20India/1-min_ft40ju.jpg"
                                        alt="1st"
                                    />
                                </div>
                                <div className="col s12 l3">
                                    ...
                                    <div className="center">
                                        <a href="/i1001" style={{ background: "#080808d9", marginTop: "2em" }} className="btn waves-effect waves-light ">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card-content">
                            <div className="row">
                                <div className="col l9 s12">
                                    <img
                                        pos
                                        className="post-image landing-post-head"
                                        src="https://res.cloudinary.com/marketgaddevcloud1/image/upload/v1594917488/Articles%20Photos/Industry/Reverse%20Logistic/2_k8fndm.jpg"
                                        alt="1st"
                                    />
                                </div>
                                <div className="col s12 l3">
                                    ...
                                    <div className="center">
                                        <a href="/i1002" style={{ background: "#080808d9", marginTop: "2em" }} className="btn waves-effect waves-light ">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card-content">
                            <div className="row">
                                ...
                                <div className="col s12 l3">
                                    ...
                                    <div className="center">
                                        <a href="/i1003" style={{ background: "#080808d9", marginTop: "2em" }} className="btn waves-effect waves-light ">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row">
                                <div className="col l9 s12">
                                    <img
                                        pos
                                        className="post-image"
                                        src="https://res.cloudinary.com/marketgaddevcloud1/image/upload/v1594919224/Articles%20Photos/Industry/FinTech/2_2_-min_whkytt.jpg"
                                        alt="1st"
                                    />
                                </div>
                                <div className="col s12 l3">
                                    ...
                                    <div className="center">
                                        <a href="/i1004" style={{ background: "#080808d9", marginTop: "2em" }} className="btn waves-effect waves-light ">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row">
                                <div className="col l9 s12">
                                    <img
                                        pos
                                        className="post-image"
                                        src="https://res.cloudinary.com/marketgaddevcloud1/image/upload/v1594921120/Articles%20Photos/Industry/Covid19%20on%20Education%20Industry/2_3_-min_squcan.jpg"
                                        alt="1st"
                                    />
                                </div>
                                <div className="col s12 l3">
                                    ...
                                    <div className="center">
                                        <a href="/i1005" style={{ background: "#080808d9", marginTop: "2em" }} className="btn waves-effect waves-light ">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="card">
                        <div className="card-content">
                            <div className="row">
                                ...
                                <div className="col s12 l3">
                                    <h3 className="center landing-post-head">
                                        12 Steps to Start a Successful Business
                                    </h3>
                                    <p className="post-brief">
                                    ...
                                    <div className="center">
                                        <a href="/i1006" style={{ background: "#080808d9", marginTop: "2em" }} className="btn waves-effect waves-light ">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>

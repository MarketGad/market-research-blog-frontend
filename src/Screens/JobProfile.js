...
const JobProfile = (props) => {
  ...
  let portfolioLink = "";
  if (UserProfile) {
    linkedin = /^https?:\/\//.test(UserProfile.linkedIn)
      ...
      <div className="profile-container">
        <Grid container component="main">
          ...
          <Grid item xs={12} md={3}>
            ...
            <div
              className="article-subhead center"
            ...
            <div style={{ textAlign: "center" }}>
              <span style={{ textAlign: "center" }}>
                <ReputationPoint
                  ReputationPoint={UserProfile.user.reputation}
                />
              </span>
            </div>
              ...
              <div className="premium-offering-container">
                ...
                <div style={{ textAlign: "center", marginTop: "3%" }}>
                  ...
                  <div style={{ padding: "5px" }}>
                    ...
                    <p className="prodcontent">
                      Rs.{UserProfile.offeringPrice / 100 || null}
                    </p>
                  </div>

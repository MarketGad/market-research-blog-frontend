    ...
    return (
        <div>
            <div>
                ...
                <p className="article-content">
                    As per our primary research, 59% of start-ups fail due to lack of market analysis. We are a group of people at MarketGad, from various technology and business backgrounds, taking an initiative to transform the start-up ecosystem of India by de-risking entrepreneurship.
                    ...
                    We believe in creating a dent in the current unemployment scenario of India by not only promoting entrepreneurship but also enabling them to validate their ideas and proceed ahead. We are creating this platform with a go-giver attitude.
                </p>
                <p className="article-subhead">
                Money follows passion. Not the other way round. Pitch decks are made after validated ideas. Not the other way round
                </p>
                <p className="article-content">
                There is a huge difference between start-ups and small businesses. If you’re looking for the later one, go on pursue it. But if you’re looking for a start-up, it simply means growth. That’s what triggers investors to put their money in. When you’re aiming for a 100% growth with a validated concept, why won’t someone invest in you? Compare it with the 10-20% return of mutual funds, people will die for investing in your start-up.
    When you’re able to validate your idea and launch a product that your customers actually need, we help you create an investor pitch.
                </p>
                <p className="article-subhead">
                Investment is just the beginning of a long journey
                </p>
                <p className="article-content">
                We’ll help you throughout your start-up journey, from recruiting your first set of employees to marketing your final product. More than just a company, you’ll build a network of experts, who can help you to building your business.
                </p>
                <p className="article-content">

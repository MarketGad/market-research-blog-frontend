    ...
    return (
        <div>
            <div className="container">
                ...
                <p className="article-content">
                    The Government of India (GOI) has made significant efforts through policy measures in the recent past to boost the logistics industry and streamline the transport sector. The policy measures include reform in the goods and services tax (GST), Public-Private Partnership (PPP), through Toll-operate-transfer (TOT) inroads, speeding the dedicated freight corridor, one country one market policy and massive investments in infrastructure. The efforts and initiative taken by the GOI may take approximately 3-4 years to show some productive results at the ground level. The policy measures taken by the GOI are discussed in brief below.
                </p>
                <p className="article-subhead">Initiatives & Legislative Reforms by GOI </p>
                <p className="article-content">
                ...
                <p className="article-subhead"><h5><b>Infrastructure Status</b> </h5></p>
                <p className="article-content">
                    The GOI granted the logistics sector the infrastructure status in November 2017 with a focus on reducing the high logistics cost, thereby increasing the competitiveness of Indian goods in both foreign and domestic market. The measures include setting up of multi-modal logistics parks comprising Inland Container Depots (ICDs), cold chain facilities, and warehousing facilities with minimum area and investment. A significant advantage for Logistics sector will be availing infrastructure loans at more accessible terms with higher limits, accessing higher amounts of funds as External Commercial Borrowings (ECB), and can borrow from India Infrastructure Financing Company Limited (IIFCL)<sup>[3]</sup>.
                </p>
                <p className="article-subhead"><h5><b>GST implementation</b></h5> </p>
                <p className="article-content">
                    The trucking industry has to spend around 50-60% of their time at interstate checkpoints and tracking of interstate sales tax to comply with state laws and taxes. With the implementation of GST, the interstate compliances and paperwork will reduce, resulting in faster turnaround time for trucks.
                </p>
                <p className="article-content">
                    Previously to save tax, manufacturers in India used to have warehouses in every state. With GST implementation, manufacturers have the flexibility to have warehouses in select states leading to the emergence of prominent hubs in major states.
                </p>
                <p className="article-content">
                    The freight was taxed multiple times owing to states own tax system, which has become uniform with GST. Pre-GST taxes were up to 26.5%, but with GST implementation, now the tax rates range between 18-21%, resulting in cost savings<sup>[4]</sup>.
                </p>
                <p className="article-subhead"><h5><b>E-Way Bill</b></h5></p>
                <p className="article-content">
                ...
                <p className="article-subhead"><h5><b>Logistics division under the Ministry of Commerce (MoC)</b></h5> </p>
                <p className="article-content">
                ...
                <p className="article-subhead"><h5><b>Dedicated Freight Corridors (DFCs) and Logistics Parks</b></h5>  </p>
                <p className="article-content">
                ...
                <p className="article-subhead"><h5><b>IT implementation</b></h5> </p>
                <p className="article-content">
                ...
                <p className="article-subhead">Proposed National Logistics Policy, 2020 </p>
                ...
                <p className="article-subhead">
                   <h5><b>Logistics infrastructure</b></h5>
                </p>
                <p className="article-content">
                ...
                <p className="article-subhead">
                    <h5><b>IT backbone of logistics</b></h5>
                </p>
                <p className="article-content">
                ...
                <p className="article-subhead">
                    <h5><b>Approvals and regulatory compliance</b></h5>
                </p>
                <p className="article-content">
                ...
                <p className="article-subhead">
                     <h5><b>Simplifying document processing</b></h5>
                </p>
                <p className="article-content">
                ...
                <p className="article-subhead">
                    <h5><b>Performance review and monitoring</b></h5>
                </p>
                <p className="article-content">
                ...
                <p className="article-subhead">
                    <h5><b>Trade facilitation measures</b></h5>
                </p>
                <p className="article-content">
                ...
                <p className="article-subhead">
                    <h5><b>Strengthening warehousing sector</b></h5>
                </p>
                <p className="article-content">

    ...
    <section className="subscribe">
      <form className="signup-form" onSubmit={submitHandler}>
        <div className="row" style={{ margin: 0 }}>
          <div
            className="col s12 l5 container ml-3 mobile-hide"
            style={{ paddingLeft: "6.5%" }}
          >
            <h6
              style={{ paddingTop: "10px", fontWeight: "600", color: "white" }}
            >
              Contact us
            </h6>
            <div>
          ...
          <div className="col s12 l5 container">
            <h6
              ...
              className="center"
            >
              Subscribe for daily products updates
            </h6>
            <div className="row subscribe-area">
              ...
              <div className="col l3 s12">
                <div>
                  <button className="signup-button btn waves-effect">
                    Subscribe
                  </button>
                </div>
              </div>

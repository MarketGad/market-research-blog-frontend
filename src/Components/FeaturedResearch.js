...
const FeaturedResearch = () => {
	const articles = [
		...
		},
		{
			...
			authorName: 'Shankhadeep Banerjee',
			postBrief:
				'The Indian Healthcare sector stands as the world’s fourth-largest employer. The country employs over 3,20,000 people all around the country, which is also estimated to cross a valuation of 40 million by the end of 2020. Gloablly it is one of the firstest growing...',
